...
if [ -f "/data/adb/easytier-magisk/config.yaml" ]; then
    mv /data/adb/easytier-magisk/config.yaml /data/adb/easytier-magisk/config.toml
fi

if [ ! -f "/data/adb/easytier-magisk/config.toml" ]; then
    mkdir -p /data/adb/easytier-magisk
    cp -rf $MODPATH/config/config.toml /data/adb/easytier-magisk/config.toml
fi
...
ui_print "配置文件位置: /data/adb/easytier-magisk/config.toml"
